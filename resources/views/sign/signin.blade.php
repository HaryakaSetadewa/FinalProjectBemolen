...
<body class="min-h-screen overflow-hidden flex items-center justify-center" style="background: #edf2f7;">
    <div class="bg-white dark:bg-gray-900 w-full">
        <div class="flex justify-center w-full h-screen">
            ...
            <!-- Image Section -->
            <div class="hidden lg:block lg:w-2/3 bg-cover" style="background-image: linear-gradient(to left, rgba(0,0,0, 0.3), rgba(0,0,0, 0.6)),
            url('{{ asset('img/imgs/mobil.jpg') }}');">
                        ...
                        <form>
                            ...
                            <div class="mt-6">
                                <button class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                    <a href="{{ route ('bemolen')}}" target="_blank">Sign in</a>
                                </button>
                            </div>
